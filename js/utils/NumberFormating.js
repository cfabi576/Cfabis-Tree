...
function t1format(x,mult=false,y) {
	let ills = ['K','M','B','T','Qd','Qn','Sx','Sp','Oc','No']
	let t1ones = ["","U","D","T","Qd","Qn","Sx","Sp","Oc","No"]
	if (mult && y>0 && x<10) t1ones = ["","","D","T","Qd","Qn","Sx","Sp","Oc","No"]
	let t1tens = ["","De","Vg","Tg","Qa","Qg","sg","Sg","Og","Nn"]
	let t1hunds = ["","Ce","Dn","Tc","Qe","Qig","Sc","Si","Oe","Ne"]
	let t1f = ills[x]
